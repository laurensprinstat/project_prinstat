...
------------------------------------------------------------------------------------------
###############################
# 6a. gender difference via T-tests
###############################
...
# First performing the data manipulation once to check whether the assumptions for a T-test are met
...
## TS: nog mee bezig
# Then performing the test 10000 times via simulation to compensate for biases in sampling
T_tests <- vector (,10000)
for (i in 1:10000) {
male23_dif <- male23$dbpdif[male23$treatment == 3] - sample(male23$dbpdif[male23$treatment == 2], size = 19)
female23_dif <- sample(female23$dbpdif[female23$treatment == 3], size = 19) - female23$dbpdif[female23$treatment == 2]
...
------------------------------------------------------------------------------------------
###############################
# 6b. Gender difference via ANOVA
###############################
...
###############################
# 7a. Power of the gender difference T-tests
###############################
```{R}
...
```
###############################
# 7b. Power of the gender difference ANOVA
###############################
```{R}
