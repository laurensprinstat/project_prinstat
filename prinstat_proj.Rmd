...
num1 <- length(male[male$treatment==3,]$dbp_end)
num2 <- length(female[female$treatment==3,]$dbp_end)
m1 <- mean(male[male$treatment==3,]$dbp_end)
m2 <- mean(female[female$treatment==3,]$dbp_end)
var1 <- var(male[male$treatment==3,]$dbp_end)
var2 <- var(female[female$treatment==3,]$dbp_end)
sd1 <- sd(male[male$treatment==3,]$dbp_end)
sd2 <- sd(female[female$treatment==3,]$dbp_end)
se <- sqrt(sd1*sd1/num1+sd2*sd2/num2)


#equal var: yes
var.test(dbp_end~sex, data23[data23$treatment==3,])
