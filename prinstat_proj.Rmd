...
# Atm making use of the raw base data - will change it
```{r}
library(corrplot);
corrplot(cor(data_raw), method = "ellipse")

# By treatment group
corrplot(cor(data_raw[data_raw$trt == 1,]), method = "ellipse")
corrplot(cor(data_raw[data_raw$trt == 2,]), method = "ellipse")
corrplot(cor(data_raw[data_raw$trt == 3,]), method = "ellipse")
```
