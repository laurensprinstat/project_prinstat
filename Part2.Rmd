...
lambda_end.2 <- delta_end.2 /  sqrt(var(data$dbp_end[data$treatment == "Treatment 1"])/n1 + 
...
lambda_end.5 <- delta_end.5 /  sqrt(var(data$dbp_end[data$treatment == "Treatment 1"])/n1 + 
                                  var(data$dbp_end[data$treatment == "Placebo"])/n2)
